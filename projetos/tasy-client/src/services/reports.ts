 ...
 * dispara generateReports, extrai os nomes de arquivo e baixa os binários.
 *
 * A biblioteca NÃO escreve em disco — devolve os bytes em memória. Persistência
 * (arquivo, HTTP response, conversão) é responsabilidade do consumidor.
